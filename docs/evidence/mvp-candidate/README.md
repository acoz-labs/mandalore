...
The [Linux ARM64 and Intel macOS checkpoint](platforms/README.md) completes native
retained CLI/MCP execution across all four declared targets. Native Codex and
